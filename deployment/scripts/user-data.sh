#!/bin/bash
# ==============================================================================
# Bootstrap Script: Apache + PHP + IMDSv2 Metadata Web App
# Attached to EC2 Launch Template: web-app-template
# ==============================================================================
...
yum install -y httpd php php-cli php-common php-mysqlnd curl
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; }
        body { background-color: #0b1320; color: #f8fafc; min-height: 100vh; display: flex; align-items: center; justify-content: center; }
        .card { background: #172236; border-radius: 12px; padding: 48px 64px; text-align: center; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.5), 0 10px 10px -5px rgba(0, 0, 0, 0.4); max-width: 520px; width: 90%; }
        h1 { color: #38bdf8; font-size: 2.2rem; margin-bottom: 24px; font-weight: 700; }
        .label { color: #94a3b8; font-size: 1.05rem; margin-top: 18px; margin-bottom: 6px; }
        .value { color: #a855f7; font-size: 1.25rem; font-weight: 600; letter-spacing: 0.5px; }
    </style>
</head>
<body>
    <div class="card">
